...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $atras ?>phpgrid/lib/js/themes/redmond/jquery-ui.custom.css"></link>     
  <link rel="stylesheet" type="text/css" media="screen" href="<?php echo $atras ?>phpgrid/lib/js/jqgrid/css/ui.jqgrid.css"></link>    
   
  <script src="<?php echo $atras ?>phpgrid/lib/js/jquery.min.js" type="text/javascript"></script> 
  <script src="<?php echo $atras ?>phpgrid/lib/js/jqgrid/js/i18n/grid.locale-en.js" type="text/javascript"></script> 
  <script src="<?php echo $atras ?>phpgrid/lib/js/jqgrid/js/jquery.jqGrid.min.js" type="text/javascript"></script>     
  <script src="<?php echo $atras ?>phpgrid/lib/js/themes/jquery-ui.custom.min.js" type="text/javascript"></script> 
</head>
