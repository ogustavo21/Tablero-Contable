...
$atras = "../../";
		...
		$consulta_liquidez = "SELECT id_liquidez FROM liquidez  WHERE  liquidez.id_ejercicio=2017  and liquidez.id_mes=18 ";
							...
							<div class="box box-primary">
								...
								<div class="box-body">
									<table width="100%">
										...
										$slcFecha = "SELECT `f_inicio`,`f_final` FROM `mes` WHERE `id_mes` = 18";
										...
										$consulta_liquidez = "SELECT id_liquidez FROM liquidez, usuarios WHERE    liquidez.id_ejercicio=2017  and liquidez.id_mes=18 ";
										$res_liquidez = $mysqli->query($consulta_liquidez);
									...
									$sql1 = "SELECT concepto_activo, SUM(activo) as tactivo   from balance_detalle INNER JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_activo  LIKE '%Total de Activo Corriente%'  AND balance.id_ejercicio=2017 and balance.id_mes=18";
									...
									$sql2 = "SELECT concepto_pasivo, SUM(pasivo) as tpasivo   from balance_detalle INNER JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_pasivo  LIKE '%Total de Pasivo Corriente%'AND balance.id_ejercicio=2017 and balance.id_mes=18";
									...
									$cajabancos = "SELECT activo from balance_detalle JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_activo  LIKE'%Fondo de Caja Chica%'  AND balance.id_ejercicio=2017 and balance.id_mes=18 union SELECT   activo from balance_detalle JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_activo  LIKE'%Caja Otros Ingresos%'  AND balance.id_ejercicio=2017 and balance.id_mes=18 UNION SELECT activo from balance_detalle JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_activo  LIKE'%Bancos%'  AND balance.id_ejercicio=2017 and balance.id_mes=18";
									...
									$inversion = "SELECT activo from balance_detalle JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_activo  LIKE'%Inversiones%'    AND balance.id_ejercicio=2017 and balance.id_mes=18";
									...
									$pasivo_cor = "SELECT pasivo from balance_detalle JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_pasivo  LIKE'%Total de Pasivo Corriente%'  AND balance.id_ejercicio=2017 and balance.id_mes=18";
									...
									$totingresoseducativosnetos= "SELECT  reala  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Total Ingresos Educativos Netos%'  AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
									...
									$subsioneto= "SELECT  reala  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Total de Otros Ingresos%'   AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
									$subsi= $mysqli->query($subsioneto);
									$totsubneto = $subsi->fetch_array();
									
																															// Egresos Operativos
									$egropera= "SELECT  reala  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%GRAN TOTAL DE GASTOS%'  AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
									$egreopera= $mysqli->query($egropera);
									$egreopera = $egreopera->fetch_array();
									

																															//Colegiaturas Mensuales por Cobrar
									$colemen= "SELECT  realm  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Enseñanza%'  AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
									$querycolemen= $mysqli->query($colemen);
									$arraycolemen = $querycolemen->fetch_array();

																																//Becas Mensuales Otorgadas
									$becamensualotorga= "SELECT realm from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Becas y Descuentos%'  AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017 UNION  SELECT  realm  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Ingresos por Colegiaturas no Recibidos%'  AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
									...
									$salinicuenclient= "SELECT activo from balance_detalle JOIN balance ON balance_detalle.id_balance=balance.id_balance  WHERE   concepto_activo  LIKE'%Cuentas por Cobrar Activas%' AND balance.id_ejercicio=2017 and balance.id_mes=18";
									...
									$salfinacuenclient= "SELECT  realm  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Enseñanza%'   AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
									...
									$colepresuanual= "SELECT anual from presupuesto_detalle INNER JOIN presupuesto ON presupuesto_detalle.id_presupuesto=presupuesto.id_presupuesto  WHERE concepto_presupuesto  LIKE'%ENSEÑANZA%' AND presupuesto.id_ejercicio=2017 and presupuesto.id_mes=18";
									...
									$bepresuanual= "SELECT anual from presupuesto_detalle INNER JOIN presupuesto ON presupuesto_detalle.id_presupuesto=presupuesto.id_presupuesto  WHERE concepto_presupuesto  LIKE'%MENOS: BECAS Y DESCUENTOS%'  AND presupuesto.id_ejercicio=2017 and presupuesto.id_mes=18 UNION SELECT anual from presupuesto_detalle INNER JOIN presupuesto ON presupuesto_detalle.id_presupuesto=presupuesto.id_presupuesto  WHERE concepto_presupuesto  LIKE'%MENOS: INGRESOS COLEG NO RECIB%'   AND presupuesto.id_ejercicio=2017 and presupuesto.id_mes=18";
									...
									$colecobraperio= "SELECT  reala  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Enseñanza%'    AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
									...
									$beotorperio= "SELECT reala from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Becas y Descuentos%'   AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017 UNION  SELECT  realm  from edo_res_detalle INNER JOIN edo_res ON edo_res_detalle.id_edo_res=edo_res.id_edo_res WHERE   concepto LIKE '%Ingresos por Colegiaturas no Recibidos%'    AND edo_res.id_mes=18 and edo_res.id_ejercicio=2017";
										...
										<thead >
											...
											<tr> 
												...
												<td><?php echo' <div class="col-lg-10" style="text-align: center" role="form"><label for="ejemplo_email_3" class="">Total Activo Corriente</label>';?> </td>
													...
													<td class="col-lg-2" >   <div class="form-line jf-required"><input   type="text" readonly id="combo" OnKeyup="sumar()" name="t_acorriente" type="text" placeholder="Total Activo Corriente" required value="<?php echo $row_liquidez[t_acorriente];?>"></div></div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="t_pcorriente">Total Pasivo Corriente</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input    readonly id="combo"  name="t_pcorriente" type="text" OnKeyup="sumar()" placeholder="Total Pasivo Corriente" required value="<?php echo $row_liquidez[t_pcorriente];?>">
														</div>
													</div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="e_operativos">Egresos Operativos de 12 meses anteriores</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input   readonly id="combo"  name="e_operativosmensual" type="text" OnKeyup="sumar()" placeholder="Egresos Operativos de 12 meses anteriores" required value="<?php echo $row_liquidez[e_operativosmensual];?>">
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class=""  for="p_aplicado">15% Aplicado</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input   OnKeyup="sumar()"  readonly id="combo"  name="p_aplicado" type="text" placeholder="15% Aplicado" required value="<?php echo $row_liquidez[p_aplicado];?>">
														</div>
													</div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="f_asignado">Fondos Asignados</label>';?></td>
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input   OnKeyup="sumar()"  readonly id="combo" name="f_asignadoanual" type="text" placeholder="Fondos Asignados" required value="<?php echo $row_liquidez[f_asignadoanual];?>">
															
														</div>
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input   OnKeyup="sumar()"  readonly id="combo"  name="f_asignadomensual" type="text" placeholder="Fondos Asignados" required value="<?php echo $row_liquidez[f_asignadomensual];?>">
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="caja_bancos">Caja, Bancos</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input   OnKeyup="sumar()"  readonly id="combo"  name="caja_bancos" type="text" placeholder="Caja, Bancos" required value="<?php echo $row_liquidez[caja_bancos];?>">
														</div>
													</div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="inversiones">Inversiones</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input   OnKeyup="sumar()"  readonly id="combo"  name="inversiones" type="text" placeholder="Inversiones" required value="<?php echo $row_liquidez[inversiones];?>">
														</div>
													</div></td>
												...
												<tr> 
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="p_corriente">Pasivo Corriente</label>';?></td>
															<td class="col-lg-1"  ><?php echo  $arrayresult2['tpasivo']?></td>
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input   OnKeyup="sumar()"  readonly id="combo" name="p_corriente" type="text" placeholder="Pasivo Corriente" required value="<?php echo $row_liquidez[p_corriente];?>">
															</div>
														</div></td>
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="f_asignadosbrutos">Fondos Asignados Brutos</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input   OnKeyup="sumar()"  readonly id="combo"  name="f_asignadosbrutos" type="text" placeholder="Fondos Asignados Brutos" required value="<?php echo $row_liquidez[f_asignadosbrutos];?>">
															</div>
														</div></td>
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="ingreso_operativo">Ingreso Operativo</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input   OnKeyup="sumar()"  readonly id="combo"  name="ingreso_operativo" type="text" placeholder="Ingreso Operativo" required value="<?php echo $row_liquidez[ingreso_operativo];?>">
															</div>
														</div></td>
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="subcidios_ingresos">Subsidios y Otros Ingresos</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input   OnKeyup="sumar()"  readonly id="combo"  name="subcidios_ingresos" type="text" placeholder="Subsidios y Otros Ingresos" required value="<?php echo $row_liquidez[subcidios_ingresos];?>">
															</div>
														</div></td>
													...
													<tr> 
														...
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="egresos_operativo">Egresos Operativos</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input   OnKeyup="sumar()"  readonly id="combo"  name="egresos_operativo" type="text" placeholder="Egresos Operativos" required value="<?php echo $row_liquidez[egresos_operativo];?>">
															</div>
														</div></td>
													...
													<tr> 
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="cole_mcobrar">Colegiaturas Mensuales por Cobrar</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"  readonly id="combo"  name="cole_mcobrar" type="text" placeholder="Colegiaturas Mensuales por Cobrar" required value="<?php echo $row_liquidez[cole_mcobrar];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="becas_motorgadas">Becas Mensuales Otorgadas</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"  readonly id="combo"  name="becas_motorgadas" type="text" placeholder="Becas Mensuales Otorgadas" required value="<?php echo $row_liquidez[becas_motorgadas];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="saldo_cclientes">Saldo Inicial en Cuenta de Clientes</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"  readonly id="combo"  name="saldo_cclientes" type="text" placeholder="Saldo Inicial en Cuenta de Clientes" required value="<?php echo $row_liquidez[saldo_cclientes];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="cobros_erealizados">Cobros Efectivamente Realizados</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"  readonly id="combo"  name="cobros_erealizados" type="text" placeholder="Cobros Efectivamente Realizados" required value="<?php echo $row_liquidez[cobros_erealizados];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="cole_preanual">Colegiaturas Presupuestadas Anualmente</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"  readonly id="combo"  name="cole_preanual" type="text" placeholder="Colegiaturas Presupuestadas Anualmente" required value="<?php echo $row_liquidez[cole_preanual];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="becas_preanual">Becas Presupuestadas Anualmente</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"  readonly id="combo"  name="becas_preanual" type="text" placeholder="Becas Presupuestadas Anualmente" required value="<?php echo $row_liquidez[becas_preanual];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="cole_cobrarperiodo">Colegiaturas Cobradas en el Período</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"  readonly id="combo"  name="cole_cobrarperiodo" type="text" placeholder="Colegiaturas Cobradas en el Período" required value="<?php echo $row_liquidez[cole_cobrarperiodo];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="becas_operiodo">Becas otorgadas en el Período</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input   OnKeyup="sumar()"   readonly id="combo"  name="becas_operiodo" type="text" placeholder="Becas otorgadas en el Período" required value="<?php echo $row_liquidez[becas_operiodo];?>">
																</div>
															</div></td>
