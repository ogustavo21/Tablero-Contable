...
$atras = "../../";
		...
		$consulta_liquidez = "SELECT id_liquidez FROM liquidez, usuarios WHERE liquidez.id_usuarios=usuarios.id_usuarios and  usuarios.id_usuarios=$_SESSION[id_usuarios] AND liquidez.id_ejercicio=$_SESSION[id_ejercicio] and liquidez.id_escuela=$_SESSION[id_superior] and liquidez.id_mes=$_SESSION[id_mes] GROUP BY usuarios.id_usuarios";
										...
										<thead >
											...
											<tr> 
												...
												<td><?php echo' <div class="col-lg-10" style="text-align: center" role="form"><label for="ejemplo_email_3" class="">Total Activo Corriente</label>';?> </td>
													...
													<td class="col-lg-2" >   <div class="form-line jf-required"><input class="form-control input-sm" type="text" readonly id="combo" OnKeyup="sumar()" name="t_acorriente" type="text" placeholder="Total Activo Corriente" required value="<?php echo $row_liquidez[t_acorriente];?>"></div></div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="t_pcorriente">Total Pasivo Corriente</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm"  readonly id="combo"  name="t_pcorriente" type="text" OnKeyup="sumar()" placeholder="Total Pasivo Corriente" required value="<?php echo $row_liquidez[t_pcorriente];?>">
														</div>
													</div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="e_operativos">Egresos Operativos de 12 meses anteriores</label>';?></td>
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm"  readonly id="combo"  name="e_operativosanual" type="text" OnKeyup="sumar()" placeholder="Egresos Operativos de 12 meses anteriores" required value="<?php echo $row_liquidez[e_operativosanual];?>">
															
														</div>
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm"  readonly id="combo"  name="e_operativosmensual" type="text" OnKeyup="sumar()" placeholder="Egresos Operativos de 12 meses anteriores" required value="<?php echo $row_liquidez[e_operativosmensual];?>">
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class=""  for="p_aplicado">15% Aplicado</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="p_aplicado" type="text" placeholder="15% Aplicado" required value="<?php echo $row_liquidez[p_aplicado];?>">
														</div>
													</div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="f_asignado">Fondos Asignados</label>';?></td>
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo" name="f_asignadoanual" type="text" placeholder="Fondos Asignados" required value="<?php echo $row_liquidez[f_asignadoanual];?>">
															
														</div>
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="f_asignadomensual" type="text" placeholder="Fondos Asignados" required value="<?php echo $row_liquidez[f_asignadomensual];?>">
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="caja_bancos">Caja, Bancos</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="caja_bancos" type="text" placeholder="Caja, Bancos" required value="<?php echo $row_liquidez[caja_bancos];?>">
														</div>
													</div></td>
												...
												<tr> 
													<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="inversiones">Inversiones</label>';?></td>
														...
														<td class="col-lg-2"> <div class="form-line jf-required">
															<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="inversiones" type="text" placeholder="Inversiones" required value="<?php echo $row_liquidez[inversiones];?>">
														</div>
													</div></td>
												...
												<tr> 
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="p_corriente">Pasivo Corriente</label>';?></td>
															<td class="col-lg-1"  ><?php echo  $arrayresult2['tpasivo']?></td>
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo" name="p_corriente" type="text" placeholder="Pasivo Corriente" required value="<?php echo $row_liquidez[p_corriente];?>">
															</div>
														</div></td>
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="f_asignadosbrutos">Fondos Asignados Brutos</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="f_asignadosbrutos" type="text" placeholder="Fondos Asignados Brutos" required value="<?php echo $row_liquidez[f_asignadosbrutos];?>">
															</div>
														</div></td>
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="ingreso_operativo">Ingreso Operativo</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="ingreso_operativo" type="text" placeholder="Ingreso Operativo" required value="<?php echo $row_liquidez[ingreso_operativo];?>">
															</div>
														</div></td>
													...
													<tr> 
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="subcidios_ingresos">Subsidios y Otros Ingresos</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="subcidios_ingresos" type="text" placeholder="Subsidios y Otros Ingresos" required value="<?php echo $row_liquidez[subcidios_ingresos];?>">
															</div>
														</div></td>
													...
													<tr> 
														...
														<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="egresos_operativo">Egresos Operativos</label>';?></td>
															...
															<td class="col-lg-2"> <div class="form-line jf-required">
																<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="egresos_operativo" type="text" placeholder="Egresos Operativos" required value="<?php echo $row_liquidez[egresos_operativo];?>">
															</div>
														</div></td>
													...
													<tr> 
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" class="" for="cole_mcobrar">Colegiaturas Mensuales por Cobrar</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="cole_mcobrar" type="text" placeholder="Colegiaturas Mensuales por Cobrar" required value="<?php echo $row_liquidez[cole_mcobrar];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="becas_motorgadas">Becas Mensuales Otorgadas</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="becas_motorgadas" type="text" placeholder="Becas Mensuales Otorgadas" required value="<?php echo $row_liquidez[becas_motorgadas];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="saldo_cclientes">Saldo Inicial en Cuenta de Clientes</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="saldo_cclientes" type="text" placeholder="Saldo Inicial en Cuenta de Clientes" required value="<?php echo $row_liquidez[saldo_cclientes];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="cobros_erealizados">Cobros Efectivamente Realizados</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="cobros_erealizados" type="text" placeholder="Cobros Efectivamente Realizados" required value="<?php echo $row_liquidez[cobros_erealizados];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="cole_preanual">Colegiaturas Presupuestadas Anualmente</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="cole_preanual" type="text" placeholder="Colegiaturas Presupuestadas Anualmente" required value="<?php echo $row_liquidez[cole_preanual];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="becas_preanual">Becas Presupuestadas Anualmente</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="becas_preanual" type="text" placeholder="Becas Presupuestadas Anualmente" required value="<?php echo $row_liquidez[becas_preanual];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3" for="cole_cobrarperiodo">Colegiaturas Cobradas en el Período</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"  readonly id="combo"  name="cole_cobrarperiodo" type="text" placeholder="Colegiaturas Cobradas en el Período" required value="<?php echo $row_liquidez[cole_cobrarperiodo];?>">
																</div>
															</div></td>
														...
														<tr> 
															<td><?php echo '<div class="col-lg-10" style="text-align: center"><label for="ejemplo_email_3"  for="becas_operiodo">Becas otorgadas en el Período</label>';?></td>
																...
																<td class="col-lg-2"> <div class="form-line jf-required">
																	<input class="form-control input-sm" OnKeyup="sumar()"   readonly id="combo"  name="becas_operiodo" type="text" placeholder="Becas otorgadas en el Período" required value="<?php echo $row_liquidez[becas_operiodo];?>">
																</div>
															</div></td>
